...
import * as RevoGridExports from '@revolist/revogrid';
import { RevoGrid as RevoGridInterfaces, Edition as RevoGridEdition } from '@revolist/revogrid/dist/types/interfaces';
export { RevoGrid };
...
export { RevoGridExports };
export { Components };
export { RevoGridInterfaces };
export { RevoGridEdition };